...
const OrderSummary = ({ order }: OrderSummaryProps) => {
  ...
  return (
    <div className="!font-manrope">
      <h2 className="h2-core flex flex-row sm:text-28 text-xl font-semibold text-primary font-times my-4">
        Tổng quan đơn hàng
      </h2>
      <div className="my-2">
        ...
        <div className="flex items-center justify-between mb-2">
          <h2 className="sm:text-28 text-xl font-semibold text-primary font-times">
            Thành tiền
          </h2>
