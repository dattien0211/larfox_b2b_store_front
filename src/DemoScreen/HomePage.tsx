  ...
  <div class="container mx-auto px-4">
    <div class="flex items-center justify-between py-4">
      ...
      <div class="hidden lg:flex items-center space-x-8 text-sm font-medium">
        ...
        <button class="border border-primary text-primary px-6 py-2 rounded-full hover:bg-primary hover:text-white">Get the app</button>
      </div>
    </div>
...
<section id="hero" class="relative hero-mesh h-[600px] flex items-center overflow-hidden">
  <div class="container mx-auto px-4 relative z-10">
    <div class="max-w-4xl">
      ...
      <h1 class="text-6xl font-extralight mb-6 leading-tight">Easy-to-use <span class="gradient-text font-medium">B2B Commerce Platform</span> for both services and goods</h1>
      <div class="flex max-w-2xl mb-8">
        <input type="text" placeholder="Search products, services..." class="flex-1 px-6 py-4 rounded-l-full border border-gray-200 focus:outline-none focus:ring-2 focus:ring-primary">
...
<section id="finance" class="py-20 bg-gray-800 text-white">
  <div class="container mx-auto px-4">
    <h2 class="text-4xl font-light text-center mb-16">Protect your <span class="gradient-text font-medium">transaction</span> and improve your <span class="gradient-text font-medium">cashflow</span></h2>
...
<section id="process" class="py-20 bg-gray-50">
  <div class="container mx-auto px-4">
    <h2 class="text-4xl font-light text-center mb-16"><span class="gradient-text font-medium">Seamless</span> process</h2>
...
<section id="news" class="py-16 bg-white">
  <div class="container mx-auto px-4">
    ...
    <p class="text-center text-gray-600 mb-8">Bắt đầu nhanh chóng mỗi ngày với bản tóm tắt tin tức từ AI agent của chúng tôi</p>
  ...
  <div class="container mx-auto px-4">
    ...
    <div class="grid md:grid-cols-3 gap-8">
      ...
      <div class="bg-white p-8 rounded-xl text-center">
        ...
        <p class="text-gray-600">Tham gia đội ngũ chuyên nghiệp và phát triển sự nghiệp trong môi trường công nghệ hiện đại</p>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="flex flex-col items-center justify-center mb-8">
      <div class="mb-6">
        <svg class="w-64 h-20" viewBox="0 0 800 200" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <rect x="48" y="48" width="44" height="8" fill="none" stroke="url(#logoGradientFooter)" stroke-width="2"></rect>
          <rect x="48" y="56" width="36" height="8" fill="none" stroke="url(#logoGradientFooter)" stroke-width="2"></rect>
          <rect x="48" y="64" width="28" height="8" fill="none" stroke="url(#logoGradientFooter)" stroke-width="2"></rect>

          <!-- A -->
          <polygon points="140,160 160,40 180,40 200,160 192,160 188,140 152,140 148,160" fill="url(#logoGradientFooter)"></polygon>
          <rect x="156" y="110" width="28" height="8" fill="white"></rect>
          <polygon points="164,48 156,88 184,88 176,48" fill="none" stroke="url(#logoGradientFooter)" stroke-width="2"></polygon>
          ...
          <rect x="256" y="48" width="24" height="8" fill="none" stroke="url(#logoGradientFooter)" stroke-width="2"></rect>
          <rect x="256" y="56" width="20" height="8" fill="none" stroke="url(#logoGradientFooter)" stroke-width="2"></rect>
          ...
          <rect x="356" y="48" width="34" height="8" fill="none" stroke="url(#logoGradientFooter)" stroke-width="2"></rect>
          <rect x="356" y="56" width="26" height="8" fill="none" stroke="url(#logoGradientFooter)" stroke-width="2"></rect>
