            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600 text-lg">
                  Comprehensive business management platform for modern
                  enterprises
                </p>
              </div>
                ...
                <div className="flex items-start space-x-6">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-gray-300 leading-relaxed">
                      ...
                      digital transformation services for Fortune 500 companies
                      across Asia Pacific.
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="text-center">
                  <div className="text-green-400 font-semibold mb-1">
                    <i className="fas fa-circle text-xs mr-2"></i>Active 5 mins
                    ago
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <button className="w-full border border-primary text-primary py-3 rounded-lg font-semibold hover:bg-primary hover:text-white">
                    <i className="fas fa-building mr-2"></i>View Company Profile
                  </button>
