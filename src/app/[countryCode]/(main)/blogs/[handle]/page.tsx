...
export default async function BlogPage({ params }: Props) {
  ...
  return (
    <div className="bg-primary-bg py-3 sm:py-6">
      <section className="relative container py-4 sm:py-6 px-4 mb-3 sm:mb-6 rounded-lg shadow-lg bg-white">
        <Breadcrumb isBlog={true} blogType={blogType} blog={blog} />
      </section>
      <section className="relative container py-4 sm:py-6 mb-6 px-4 sm:mb-10 rounded-lg shadow-lg bg-white">
        <div
      ...
      {relatedBlogs.length > 0 && (
        <section className="relative container py-4 sm:py-6 my-6 px-4 sm:my-10 rounded-lg shadow-lg bg-white">
          <div>
