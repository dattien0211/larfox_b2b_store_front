      ...
      <div className="content-container bg-white rounded-lg shadow-lg pt-4 pb-12  sm:pt-6 sm:pb-16 mb-4 sm:mb-8 relative">
        ...
        <section>
          ...
          <div className="text-sm sm:text-base space-y-1 sm:space-y-2 indent-2 sm:indent-4 ">
            <span className="pr-1"> {storeConfig.STORE_WEB_NAME}</span>không
            bán, chia sẻ hay trao đổi thông tin cá nhân của khách hàng thu thập
            ...
            <p>
              ...
              <span className="px-1">{storeConfig.STORE_WEB_NAME}</span> thu
              thập bao gồm:
            </p>
            <p>Họ và tên</p>
            <p>Địa chỉ</p>
        ...
        <section>
          ...
          <div className="text-sm sm:text-base space-y-1 sm:space-y-2 text-justify sm:text-left indent-2 sm:indent-4 ">
            <p>
              ...
              <span className="px-1"> {storeConfig.STORE_WEB_NAME}</span> sử
              dụng trong nội bộ công ty và cho một hoặc tất cả các mục đích sau
              đây:
            </p>
            ...
            <p>
              ...
              web của chúng tôi theo yêu cầu của bạn
            </p>
            <p>
              - Chúng tôi có thể sẽ gửi thông tin sản phẩm, dịch vụ mới, thông
        ...
        <section>
          ...
          <div className="text-justify sm:text-left sm:text-base text-sm indent-2 sm:indent-4 ">
            ...
            <span className="px-1"> {storeConfig.STORE_WEB_NAME}</span> chỉ xóa
            đi dữ liệu này nếu khách hàng có yêu cầu, khách hàng yêu cầu gửi
            mail về
        ...
        <section>
          ...
          <div className="text-justify sm:text-left sm:text-base text-sm space-y-1 sm:space-y-2 indent-2 sm:indent-4 ">
            <p>
              {storeConfig.STORE_WEB_NAME} không thu thập thông tin khách hàng
              qua trang web, thông tin cá nhân khách hàng được thực hiện thu
              thập qua email liên hệ đặt mua sản phẩm, dịch vụ gửi về hộp mail
              của chúng tôi:
              <span className="px-1">{storeConfig.STORE_EMAIL}</span> hoặc số
              điện thoại liên hệ đặt mua sản phẩm gọi về{" "}
              {storeConfig.STORE_PHONE}
            </p>
            <p>
              Bạn có thể liên hệ địa chỉ email cùng số điện thoại trên để yêu
              cầu
        ...
        <section>
          ...
          <div className="text-justify sm:text-left sm:text-base text-sm space-y-1 sm:space-y-2 indent-2 sm:indent-4 ">
            <p>
              ...
              <span className="px-1"> {storeConfig.STORE_WEB_NAME}</span> cam
              kết không chia sẻ, bán hoặc cho thuê thông tin cá nhân của bạn cho
              bất kỳ người nào khác.{" "}
              <span className="px-1"> {storeConfig.STORE_WEB_NAME}</span> cam
              kết chỉ sử dụng các thông tin của bạn vào các trường hợp sau:
            </p>
            ...
            <p>
              {storeConfig.STORE_WEB_NAME} hiểu rằng quyền lợi của bạn trong
              việc bảo vệ thông tin cá nhân cũng chính là trách nhiệm của chúng
              tôi nên trong bất kỳ trường hợp có thắc mắc, góp ý nào liên quan
              đến chính sách bảo mật của
