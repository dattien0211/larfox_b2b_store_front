...
export const metadata: Metadata = {
  title: "Chính Sách Đổi Trả Và Hoàn Tiền | Bông Lúa",
  description:
    "Các thông tin liên quan đến chính sách đổi trả và hoàn tiền của Bông Lúa.",
}
  ...
  return (
    <div className="bg-primary-bg pt-3 pb-8 sm:pt-6 sm:pb-14">
      <div className="content-container bg-white rounded-lg shadow-lg pt-4 pb-12  sm:pt-6 sm:pb-16 mb-4 sm:mb-8 relative">
        ...
        <p className="text-justify sm:text-normal sm:text-base text-sm mt-2 indent-2 sm:indent-4">
        ...
        <section>
          ...
          <div className="text-justify sm:text-normal sm:text-base text-sm">
            ...
            <div className="py-2 indent-2 sm:indent-4 space-y-1 sm:space-y-2 pl-2 sm:pl-4">
              <p>
                1. Nhầm sản phẩm, thiếu hoặc thừa sản phẩm so với đơn hàng đã
                xác nhận
              </p>
            ...
            <div className="space-y-1 sm:space-y-2">
              ...
              <div className="space-y-1 sm:space-y-2 indent-2 sm:indent-4 ">
                <p>
                  Bước 1. Quý khách vui lòng thông báo cho Bông Lúa trong vòng
                  24h kể từ khi nhận hàng, kèm theo ảnh chụp gói hàng và toàn bộ
                  sản phẩm nhận được
                </p>
                <p>
                  Bước 2. Bông Lúa tiến hành gửi mặt hàng thiếu/lỗi, hỏng đúng
                  số lượng và chủng loại cho quý khách trong vòng 5 ngày từ khi
                  nhận được yêu cầu
                </p>
                <p>
              ...
              <p className="indent-2 sm:indent-4">
                Phí vận chuyển đổi trả: với sản phẩm cần đổi do 03 lý do trên,
                quý khách không phải trả phí vận chuyển, mọi chi phí vận chuyển
                phát sinh sẽ do Bông Lúa thanh toán bằng hình thức thanh toán
                trực tiếp cho đơn vị vận chuyển.
              </p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="text-justify sm:text-normal sm:text-base text-sm ">
            <p className="indent-2 sm:indent-4">
              Với mong muốn Khách lựa chọn được sản phẩm tốt và có trải nghiệm
              hài lòng nhất, cũng như đảm bảo niềm tin vào sản phẩm Bông Lúa,
              khách hàng có thể đổi trả sản phẩm đã mua tại Bông Lúa trong vòng
              05 ngày kể từ khi nhận hàng.
              <br />
            </p>
            <p className="mt-2">
              Điều kiện đổi trả:
            ...
            <ul className="mt-2 pl-6 list-disc">
              <li>
                Sản phẩm chưa qua sử dụng, còn nguyên bao bì đóng gói, đầy đủ
                phụ kiện nếu có.
                <br />
              </li>
              <li>
        ...
        <section>
          ...
          <div className="text-justify sm:text-normal sm:text-base text-sm space-y-1 sm:space-y-2">
            ...
            <div className="pl-3 sm:pl-6 space-y-1 sm:space-y-2">
              <p>
                Bước 1: Quý khách gửi hàng về cho Bông Lúa theo quy định (Phí
                vận chuyển sẽ do Bông Lúa thanh toán)
              </p>
              <p>
            ...
            <p className="indent-2  sm:indent-4">
              Trong các trường hợp Bảo hành hoặc Đổi trả có yêu cầu gửi hàng về
              Cỏ Mềm, Quý khách vui lòng đóng gói sản phẩm cẩn thận nhằm đảm bảo
              trạng thái nguyên vẹn và gửi hàng cho đối tác vận chuyển trong
              vòng 48h kể từ khi hoàn thành việc trao đổi xác nhận thông tin với
              Bông Lúa về đơn hàng. Bông Lúa rất tiếc sẽ phải từ chối sản phẩm
              bị hư hại do lỗi đóng gói sơ sài từ Quý khách.
            </p>
            <p className="indent-2  sm:indent-4">
              Địa chỉ nhận hàng đổi trả: {storeConfig.STORE_ADDRESS}
            </p>
          </div>
        </section>
      </div>
